...
public class Algorithm {
    ...
    // It will help to store the path as a String
    String via;

    // It will help to store the shortest path
    ArrayList<Integer> path;

    // It will help to store the shortest distance
    int distance;
    ...
    public void Dijkstra(int graph[][], int source, int destination){
        ...
        // here, size is the number of vertex
